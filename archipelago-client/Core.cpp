...
BOOL CCore::Initialise() {
	...
	if (CheckOldApFile()) {
		Core->Logger("The AP.json file is not supported in this version, make sure to finish your previous seed on version 0.0.1 or use this version on the new Archipelago server\n\n");
	}
